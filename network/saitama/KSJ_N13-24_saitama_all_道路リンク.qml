...
<qgis version="3.34.0" styleCategories="Symbology">
  <renderer-v2 type="categorizedSymbol" attr="N13_003" forceraster="0" symbollevels="1" usingSymbolLevels="1" enableorderby="0">
    <categories>
      ...
      <category symbol="2" value="2" label="都道府県道" render="true"/>
      <category symbol="3" value="3" label="市区町村道等" render="true"/>
      <category symbol="4" value="5" label="その他" render="true"/>
      <category symbol="5" value="6" label="不明" render="true"/>
    </categories>
    <symbols>
      ...
      <symbol name="3" type="line" alpha="1" clip_to_extent="1" is_animated="0" frame_rate="10">
        <data_defined_properties><Option type="Map"><Option name="name" type="QString" value=""/><Option name="properties"/><Option name="type" type="QString" value="collection"/></Option></data_defined_properties>
      ...
      <symbol name="4" type="line" alpha="1" clip_to_extent="1" is_animated="0" frame_rate="10">
        <data_defined_properties><Option type="Map"><Option name="name" type="QString" value=""/><Option name="properties"/><Option name="type" type="QString" value="collection"/></Option></data_defined_properties>
        <layer class="SimpleLine" enabled="1" pass="0" locked="0">
          <Option type="Map">
      ...
      <symbol name="5" type="line" alpha="1" clip_to_extent="1" is_animated="0" frame_rate="10">
        <data_defined_properties><Option type="Map"><Option name="name" type="QString" value=""/><Option name="properties"/><Option name="type" type="QString" value="collection"/></Option></data_defined_properties>
        <layer class="SimpleLine" enabled="1" pass="0" locked="0">
          <Option type="Map">
